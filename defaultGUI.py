...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.checkBoxSuavizado.setGeometry(QtCore.QRect(110, 10, 70, 17))
        self.checkBoxSuavizado.setObjectName("checkBoxSuavizado")
        self.line = QtWidgets.QFrame(Dialog)
        self.line.setGeometry(QtCore.QRect(90, 10, 20, 81))
        self.line.setFrameShape(QtWidgets.QFrame.VLine)
        self.line.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line.setObjectName("line")
        self.LEsuavizadoX = QtWidgets.QLineEdit(Dialog)
        self.LEsuavizadoX.setGeometry(QtCore.QRect(150, 30, 21, 20))
        self.LEsuavizadoX.setObjectName("LEsuavizadoX")
        self.LEsuavizadoY = QtWidgets.QLineEdit(Dialog)
        self.LEsuavizadoY.setGeometry(QtCore.QRect(150, 60, 21, 20))
        self.LEsuavizadoY.setObjectName("LEsuavizadoY")
        self.label_2 = QtWidgets.QLabel(Dialog)
        self.label_2.setGeometry(QtCore.QRect(110, 30, 47, 16))
        self.label_2.setObjectName("label_2")
        self.label_3 = QtWidgets.QLabel(Dialog)
        self.label_3.setGeometry(QtCore.QRect(110, 60, 47, 16))
        self.label_3.setObjectName("label_3")
        self.line_3 = QtWidgets.QFrame(Dialog)
        self.line_3.setGeometry(QtCore.QRect(180, 10, 20, 81))
        ...
        self.label_5.setGeometry(QtCore.QRect(210, 30, 47, 16))
        self.label_5.setObjectName("label_5")
        self.label_6 = QtWidgets.QLabel(Dialog)
        self.label_6.setGeometry(QtCore.QRect(210, 60, 51, 16))
        self.label_6.setObjectName("label_6")
        self.LEumbralInf = QtWidgets.QLineEdit(Dialog)
        self.LEumbralInf.setGeometry(QtCore.QRect(270, 30, 31, 20))
        self.LEumbralInf.setObjectName("LEumbralInf")
        self.LEumbralSup = QtWidgets.QLineEdit(Dialog)
        self.LEumbralSup.setGeometry(QtCore.QRect(270, 60, 31, 20))
        self.LEumbralSup.setObjectName("LEumbralSup")
        self.line_4 = QtWidgets.QFrame(Dialog)
        self.line_4.setGeometry(QtCore.QRect(310, 10, 20, 81))
        self.line_4.setFrameShape(QtWidgets.QFrame.VLine)
        self.line_4.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_4.setObjectName("line_4")
        self.checkBoxBinarizado = QtWidgets.QCheckBox(Dialog)
        self.checkBoxBinarizado.setGeometry(QtCore.QRect(10, 10, 70, 17))
        ...
        self.LEumbralBin.setGeometry(QtCore.QRect(50, 30, 31, 20))
